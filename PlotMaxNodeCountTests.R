...
run(max_node_count_loaded, max_node_count_labels, "MaxNodeCount_Reliability.pdf", reliability, "Max Node Count", legendBottomLeftCorner, pdfWidth, pdfHeight, xyratio=fiveTestsXYRatio, ylim=c(0,1), ylab="Reliability (Mean & STDEV)", num_cols = 4)
run(max_node_count_loaded, max_node_count_labels, "MaxNodeCount_NewReliability.pdf", calculatePostPresentationReliabilityCached, "Max Node Count", legendBottomLeftCorner, pdfWidth, pdfHeight, xyratio=fiveTestsXYRatio, ylim=c(0,1), ylab="Reliability (Mean & STDEV)", num_cols = 4)
