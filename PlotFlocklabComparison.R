...
#run(chaos_comparison_loaded, chaos_comparison_labels, "FlocklabComparison_OldReliability.pdf", reliability, "Protocol", c(2.65, 0.05), 3.5, 5.5, xyratio=2, ylim=c(0,1), ylab="Reliability (Mean & STDEV)")
run(chaos_comparison_loaded, chaos_comparison_labels, "FlocklabComparison_Reliability.pdf", calculatePostPresentationReliabilityCached, "Protocol", c(2.65, 0.05), 3.5, 5.5, xyratio=2, ylim=c(0,1), ylab="Reliability (Mean & STDEV)")
