...
#run(competition_radius_loaded, competition_radius_labels, "CompetitionRadius_OldReliability.pdf", reliability, "Competition Radius (hops)", legendBottomLeftCorner, pdfWidth, pdfHeight, xyratio=nineTestsXYRatio, ylim=c(0,1), ylab="Reliability (Mean & STDEV)")
run(competition_radius_loaded, competition_radius_labels, "CompetitionRadius_Reliability.pdf", calculatePostPresentationReliabilityCached, "Competition Radius (hops)", legendBottomLeftCorner, pdfWidth, pdfHeight, xyratio=nineTestsXYRatio, ylim=c(0,1), ylab="Reliability (Mean & STDEV)")
run(competition_radius_loaded, competition_radius_labels, "CompetitionRadius_Stability.pdf", calculateStabilityCached, "Competition Radius (hops)", legendBottomLeftCorner, pdfWidth, pdfHeight, xyratio=nineTestsXYRatio, ylim=c(0,1), ylab="Stability (Mean & STDEV)")
#run(competition_radius_loaded, competition_radius_labels, "CompetitionRadius_WeakReliability.pdf", weakReliability, "Competition Radius (hops)", legendBottomLeftCorner, pdfWidth, pdfHeight, xyratio=nineTestsXYRatio, ylim=c(0,1), ylab="Reliability (Mean & STDEV)")
run(competition_radius_loaded, competition_radius_labels, "CompetitionRadius_Latency.pdf", getOffSlots, "Competition Radius (hops)", legendTopLeftCorner, pdfWidth, pdfHeight, xyratio=nineTestsLatencyXYRatio, ylim=c(0, 150), ylab="Latency (Mean & STDEV)")
