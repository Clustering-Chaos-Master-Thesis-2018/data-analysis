...
run(competition_radius_loaded, competition_radius_labels, "CompetitionRadius.pdf", reliability, "Competition Radius", c(0.735, 0.80), 13, 5.5, xyratio=3, ylim=c(0,1), ylab="Reliability (Mean & STDEV)")
run(competition_radius_loaded, competition_radius_labels, "CompetitionRadius_WeakReliability.pdf", weakReliability, "Competition Radius", c(0.735, 0.80), 13, 5.5, xyratio=3, ylim=c(0,1), ylab="Reliability (Mean & STDEV)")
run(competition_radius_loaded, competition_radius_labels, "CompetitionRadius_Latency.pdf", getOffSlots, "Competition Radius", c(0.05, 0.80), 13, 5.5, 0.02, ylim=c(0, 150), ylab="Latency (Mean & STDEV)")
