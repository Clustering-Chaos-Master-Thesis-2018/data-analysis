...
run(competition_radius_loaded, competition_radius_labels, "CompetitionRadius_Reliability.pdf", reliability, "Competition Radius (hops)", legendBottomLeftCorner, pdfWidth, pdfHeight, xyratio=nineTestsXYRatio, ylim=c(0,1), ylab="Reliability (Mean & STDEV)")
run(competition_radius_loaded, competition_radius_labels, "CompetitionRadius_NewReliability.pdf", calculatePostPresentationReliabilityCached, "Competition Radius (hops)", legendBottomLeftCorner, pdfWidth, pdfHeight, xyratio=nineTestsXYRatio, ylim=c(0,1), ylab="Reliability (Mean & STDEV)")
